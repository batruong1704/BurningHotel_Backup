        ...
        <div class="menu-nav">
            <nav class="navbar navbar-expand-lg">
                <div class="container-fluid px-5">
                    <a class="navbar-brand" href="./index1.php"><img src="../img/logoBurning.png" alt="BurningLogo" class="logo">
                        BURNING</a>
                    ...
                    <div class="sub-nav collapse navbar-collapse flex-row-reverse" id="navbarSupportedContent">
                        <ul class="navbar-nav mb-2 mb-lg-0">
                            <li class="nav-item p-3 me-4">
                                <a class="a nav-link active" aria-current="page" href="./index1.php">Trang Chủ</a>
                            </li>
